...
doors. The first time through, you visit every door and toggle the door 
...
#This sets doors as initially one way (in this circumstance, false = closed), 
# tells python that all doors are closed
doorstate = [False] * number_of_doors


#F strings again! Mixes printed text with automated bits! This page asks us to
# print the number of doors, which is largely to check that python got it right.
print(f"number of doors: {number_of_doors}")
#Ok, a loop here. For every run in the number of runs (deifned as from 1 to the
# number of doors + 1 because python counts from 0 and I got confused)
